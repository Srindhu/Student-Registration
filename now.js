...
form.addEventListener('submit', function(event) {
    ...
    const schoolUniversity = document.getElementById("sru").value;
    ...
    if (editingRow) {
        editingRow.innerHTML = `
            ...
            <td class="tablefield2">${studentId}</td>
            <td class="tablefield2">${studentClass}</td>
            
            <td class="tablefield2">${schoolUniversity}</td>
            ...
            <td class="border-black border-2 p-2 flex justify-around">
                <button class="edit-btn p-2 bg-pink-400 rounded-xl hover:bg-pink-400">Edit</button> 
        ...
        nRow.innerHTML = `
            ...
            <td class="tablefield2">${contactNumber}</td>
            <td class="border-black border-2 p-2 flex justify-around">
                <button class="edit-btn p-2 bg-green-400 rounded-xl hover:bg-yellow-200">Edit</button>
                <button class="fas fa-trash delete-btn text-red-600 hover:bg-green-500 rounded-lg p-2"></button>
            </td>
        `;
...
function attachEventListeners(row) {
    ...
    editBtn.addEventListener('click', function() {
        ...
        document.getElementById("sru").value = cells[3].textContent;
        document.getElementById("seid").value = cells[4].textContent;
        document.getElementById("scn").value = cells[5].textContent;
    });
}
    ...
    tableData.forEach(rowData => {
        ...
        nRow.innerHTML = `
            ...
            <td class="border-2 p-2 flex justify-around">
                <button class="edit-btn p-2 bg-green-500 rounded-xl hover:bg-pink-400">Edit</button>
                <button class="fas fa-trash delete-btn text-red-600 hover:bg-blue-500 rounded-lg p-2"></button>
            </td>
        `;
        tableBody.appendChild(nRow);
